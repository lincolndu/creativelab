    ...
    */
    ...
    function hideOver(){     
        if(!ft){
            ...
            setTimeout(endScratchIfInactive, 4e3);
            ft = true;
        }
    }
    ...
    function hideOverEl(){
        ...
        .onUpdate(function(){
            ...
            lead_box.querySelector(".flyingBG").classList="flyingBG fadeInDown";
            lead_box.querySelector(".flyingButton").classList="flyingButton flyingMove";
        })
        .start();
    ...
    image.src = '//creative.octagen.info/scratch/creme/images/germhand.png';
